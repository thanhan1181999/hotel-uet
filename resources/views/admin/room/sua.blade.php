    ...
    <div class="col-md-12" style="border: 1px solid grey;">
        <div class="panel panel-default">
            <div class="panel-body">
                <form method="post" style="margin-bottom: 30px;" action="admin/quanly/sua_room">
                    ...
                    <div>
                        ...
                        <select class="form-control" name='room_type'>
                            ...
                            <option value="{{ $rt->id }}" @if($room->id_room_type==$rt->id) selected @endif>{{ $rt->name }}</option>
                            @endforeach
                        </select>
                    </div>
                    <br>
                    <div>
                        ...
                        <input style="color:black;" type="text" class="form-control" placeholder="Mã phòng" name="so_phong" aria-describedby="basic-addon1" value="{{ $room->so_phong }}">
                    </div>
                    <br />
